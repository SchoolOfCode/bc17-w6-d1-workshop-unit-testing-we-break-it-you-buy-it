...
test("Player chooses paper, computer chooses paper, should be draw", () => {
  expect(calculateRoundResult(PAPER, PAPER)).toStrictEqual({
    outcome: DRAW,
...
test("Player chooses scissors, computer chooses paper, should be win", () => {
  expect(calculateRoundResult(SCISSORS, PAPER)).toStrictEqual({
    outcome: WIN,
...
//LOSSES
test("Player chooses paper, computer chooses scissors, should be a loss", () => {
  expect(calculateRoundResult(PAPER, SCISSORS)).toStrictEqual({
    outcome: LOSS,
    message: "Player chose paper and computer chose scissors. Computer wins.",
  });
});

test("Player chooses scissors, computer chooses rock, should be a loss", () => {
  expect(calculateRoundResult(SCISSORS, ROCK)).toStrictEqual({
    outcome: LOSS,
    message: "Player chose scissors and computer chose rock. Computer wins.",
  });
});

test("Player chooses rock, computer chooses paper, should be a loss", () => {
